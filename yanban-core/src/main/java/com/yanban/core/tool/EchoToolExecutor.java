...
public class EchoToolExecutor implements ToolExecutor {
    ...
    public ToolDescriptor descriptor() {
        return new ToolDescriptor(
                definition.name(), "v1", "diagnostic",
                java.util.List.of(ToolDescriptor.CapabilityProfile.CHAT), java.util.List.of(),
                java.util.List.of(ToolDescriptor.ResourceScope.SESSION), ToolDescriptor.SideEffectType.NONE,
                ToolDescriptor.ConfirmationPolicy.NEVER, ToolDescriptor.AsyncMode.SYNC,
                ToolDescriptor.IdempotencyPolicy.NONE, ToolDescriptor.RepeatPolicy.DENY_SAME_INPUT, false);
    }
